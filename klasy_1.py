...
class NaszaKlasa(object):  # Klasa -> może byc też bez (object) -> class NaszaKlasa:
    ...
    def __init__(self, param, *args, **kwargs):  # self - ten właśnie obiekt który w tym momencie jest tworzony i przekazywany do konstruktora
        ...
        self.etykieta = param  # Przejecie tego co było przekazane przez parametr i zapisanie tego do wewnątrz obiektu -> w obiekcie self utwórz etykietę imie i przypisz ją do wartości przekazanej pzrez parametr
...
class Osoba:
    def __init__(self, imie='Bezimienny'):  # Domyślny parametr który potem nadpisujemy
        self.imie = imie
    def __del__(self):
...
#wywołanie Klasy -> tym samym stworzenie obiektu
jan = Osoba('Jan')
print jan.imie

#Usuwanie etykiety/obiektu - > usunięcie etykiety wiąże się najczęsciej z usunięciem obiektu po prostu przez Garbage Kolektor
del jan
